...
snapshots["ReservationUnitTestCase::test_filtering_by_keyword_group 1"] = {
    "data": {
        "reservationUnits": {
            "edges": [
                {"node": {"keywordGroups": [{"name": "Sports"}], "name": "Test name"}}
            ]
        }
    }
}
...
snapshots["ReservationUnitTestCase::test_filtering_by_max_persons 1"] = {
    "data": {
        "reservationUnits": {
            "edges": [{"node": {"maxPersons": 110, "name": "Test name"}}]
        }
    }
}
...
snapshots[
    "ReservationUnitTestCase::test_filtering_by_reservation_unit_description 1"
] = {
    "data": {
        "reservationUnits": {
            "edges": [
                {"node": {"description": "Lorem ipsum", "name": "Test name"}},
                {"node": {"description": "Lorem ipsum", "name": "Test name"}},
            ]
        }
    }
...
snapshots["ReservationUnitTestCase::test_filtering_by_reservation_unit_name 1"] = {
    "data": {
        "reservationUnits": {
            "edges": [{"node": {"name": "Test name"}}, {"node": {"name": "Test name"}}]
        }
    }
}
...
snapshots["ReservationUnitTestCase::test_filtering_by_space_name 1"] = {
    "data": {
        "reservationUnits": {
            "edges": [
                {"node": {"name": "Test name", "spaces": [{"name": "space name"}]}}
            ]
        }
    }
}
            ...
            "edges": [
                {
                    "node": {
                        "name": "Test name",
                        "reservationUnitType": {"name": "Test type"},
                    }
                }
            ]
        }
            ...
            "edges": [
                {
                    "node": {
                        ...
                        "resources": [],
                        "services": [],
                        "spaces": [{"name": "Large space"}, {"name": "Small space"}],
                        "termsOfUse": "",
                    }
                }
            ]
