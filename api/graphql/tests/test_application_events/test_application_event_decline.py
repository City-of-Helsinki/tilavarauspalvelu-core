...
class ApplicationEventDeclineTestCase(ApplicationEventPermissionsTestCaseBase):
    ...
    def test_decline_success_when_admin(self):
        ...
        assert_that(self.application_event.status).is_equal_to(ApplicationEventStatus.CREATED)
        ...
        assert_that(deny_data.get("status")).is_equal_to(ApplicationEventStatus.DECLINED)
        self.application_event.refresh_from_db()
        assert_that(self.application_event.status).is_equal_to(ApplicationEventStatus.DECLINED)
    ...
    def test_cant_decline_if_status_not_in_valid_decline_statuses(self):
        ...
        assert_that(content.get("errors")).is_not_none()
        self.application_event.refresh_from_db()
        assert_that(self.application_event.status).is_equal_to(ApplicationEventStatus.RESERVED)
