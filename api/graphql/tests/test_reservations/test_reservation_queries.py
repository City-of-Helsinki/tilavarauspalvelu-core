...
class ReservationQueryTestCase(ReservationTestCaseBase):
    ...
    def test_filter_by_unit_multiple_values(self):
        ...
        ReservationFactory(name="Another reservation", reservation_units=[reservation_unit])
    ...
    def test_order_by_reservation_unit_name(self):
        ...
        ReservationFactory(name="this should be 1st", reservation_units=[res_unit_a])
        ReservationFactory(name="this should be 2nd", reservation_units=[res_unit_b])
        ReservationFactory(name="this should be 3rd", reservation_units=[res_unit_c])
    ...
    def test_filter_by_multiple_reservation_unit(self):
        ...
        ReservationFactory(
            ...
            reservee_first_name="First",
            reservee_last_name="Name",
            reservation_units=[not_visible_unit],
        )
