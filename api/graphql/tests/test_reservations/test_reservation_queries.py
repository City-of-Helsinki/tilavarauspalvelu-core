...
class ReservationQueryTestCase(ReservationTestCaseBase):
    ...
    def test_order_by_reservation_unit_name(self):
        ...
        ReservationFactory(name="this should be 1st", reservation_unit=[res_unit_a])
        ReservationFactory(name="this should be 2nd", reservation_unit=[res_unit_b])
        ReservationFactory(name="this should be 3rd", reservation_unit=[res_unit_c])
