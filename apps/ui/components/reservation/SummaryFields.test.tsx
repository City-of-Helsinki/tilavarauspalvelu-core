...
describe("Component: Reservation Details", () => {
  it.for(getFilteredSupportedFields())(
    ...
    ({ fieldName }) => {
      ...
      expect(
        screen.queryByText(`reservationApplication:label.common.${fieldName}`)
      ).not.toBeInTheDocument();
      expect(
        screen.queryByTestId(`reservation__${fieldName}`)
      ).not.toBeInTheDocument();
    }
  );
  ...
  describe("Type: individual", () => {
    it.for(getFilteredSupportedFields(CustomerTypeChoice.Individual))(
      ...
      ({ fieldName }) => {
        ...
        expect(
          screen.getByTestId(`reservation__${fieldName}`)
        ).toBeInTheDocument();
        expect(
          screen.getByText(
  ...
  describe("Type: Nonprofit", () => {
    it.for(getFilteredSupportedFields(CustomerTypeChoice.Nonprofit))(
      ...
      ({ fieldName }) => {
        ...
        expect(
          screen.getByText(
            `reservationApplication:label.nonprofit.${fieldName}`
          )
        ).toBeInTheDocument();
      }
    );
  ...
  describe("Type: Business", () => {
    it.for(getFilteredSupportedFields(CustomerTypeChoice.Business))(
      ...
      ({ fieldName }) => {
        ...
        expect(
          screen.getByText(`reservationApplication:label.business.${fieldName}`)
        ).toBeInTheDocument();
      }
    );
  });
