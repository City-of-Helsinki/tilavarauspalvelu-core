...
const appRoundNodes: ApplicationRoundNode[] = [
  ...
  },
  {
    ...
    nameFi: "Fallkullan, Malmin ja Pukinmäen nuorisotalojen vakiovuorot syksy 2021 - kevät 2022 FI",
    nameEn: "Fallkullan, Malmin ja Pukinmäen nuorisotalojen vakiovuorot syksy 2021 - kevät 2022 EN",
    nameSv: "Fallkullan, Malmin ja Pukinmäen nuorisotalojen vakiovuorot syksy 2021 - kevät 2022 SV",
    applicationPeriodBegin: "2021-04-19T06:00:00Z",
    applicationPeriodEnd: "2021-04-30T13:00:00Z",
    reservationPeriodBegin: "2021-08-16",
    reservationPeriodEnd: toApiDate(addMonths(new Date(), 1)) ?? "",
  ...
  },
  {
    ...
    nameFi: "Nuorten ympäristötilan (Laajasalo) vakiovuorot syksy 2021 - kevät 2022 FI",
    nameEn: "Nuorten ympäristötilan (Laajasalo) vakiovuorot syksy 2021 - kevät 2022 EN",
    nameSv: "Nuorten ympäristötilan (Laajasalo) vakiovuorot syksy 2021 - kevät 2022 SV",
    applicationPeriodBegin: addDays(new Date(), 7).toISOString(),
    applicationPeriodEnd: addDays(new Date(), 17).toISOString(),
    reservationPeriodBegin: "2021-08-16",
    reservationPeriodEnd: toApiDate(addMonths(new Date(), 1)) ?? "",
...
name: "Nuorten liikuntavuorot kevät 2021 FI",
  ...
  },
  {
    ...
    nameFi: "Arabian, Koskelan ja Pasilan nuorisotalojen vakiovuorot syksy 2021 - kevät 2022 FI",
    nameEn: "Arabian, Koskelan ja Pasilan nuorisotalojen vakiovuorot syksy 2021 - kevät 2022 EN",
    nameSv: "Arabian, Koskelan ja Pasilan nuorisotalojen vakiovuorot syksy 2021 - kevät 2022 SV",
    applicationPeriodBegin: "2021-04-19T06:00:00Z",
    applicationPeriodEnd: "2021-12-30T13:00:00Z",
    reservationPeriodBegin: toApiDate(addMonths(new Date(), 1)) ?? "",
    reservationPeriodEnd: toApiDate(addMonths(new Date(), 5)) ?? "",
