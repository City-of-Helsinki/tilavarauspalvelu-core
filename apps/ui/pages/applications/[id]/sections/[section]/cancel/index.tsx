...
import { fromApiDate, formatDate } from "common/src/date-utils";
...
function ApplicationSectionInfoCard({
  ...
  const begin = formatDate(fromApiDate({ date: reservationsBeginDate ?? "" }));
  const end = formatDate(fromApiDate({ date: reservationsEndDate ?? "" }));
