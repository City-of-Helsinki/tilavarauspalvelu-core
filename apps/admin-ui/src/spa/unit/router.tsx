...
const ReservationUnitEditor = dynamic(() => import("../ReservationUnit/edit/index"));

export function UnitsRouter({ reservationUnitPreviewUrl }: { reservationUnitPreviewUrl: string }) {
  return (
    <Routes>
      <Route path=":unitPk/spacesResources" element={<SpacesResources />} />
      <Route path=":unitPk/space/:spacePk" element={<SpaceEditorView />} />
      <Route path=":unitPk/resource/:resourcePk" element={<ResourceEditorView />} />
      <Route
        index
        path=":unitPk/reservationUnit/"
        element={<ReservationUnitEditor previewUrlPrefix={reservationUnitPreviewUrl} />}
      />
      <Route
