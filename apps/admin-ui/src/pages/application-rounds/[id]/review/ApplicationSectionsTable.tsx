...
const getColConfig = (t: TFunction) =>
  [
    {
      headerTKey: "applicationSchedule:headings.id",
      key: "application_id,pk",
      transform: ({ pk, applicationPk }: ApplicationSectionView) => `${applicationPk}-${pk}`,
    },
    {
      headerTKey: "applicationSchedule:headings.customer",
      key: "applicant",
    ...
    {
      headerTKey: "applicationSchedule:headings.stats",
      key: "applicationCount",
      transform: ({ applicationCount }: ApplicationSectionView) => applicationCount,
    },
    {
      headerTKey: "applicationSchedule:headings.phase",
      key: "status",
...
export function ApplicationSectionsTable({
  ...
  if (views.length === 0) {
    const name = t("applicationSchedule:emptyFilterPageName");
