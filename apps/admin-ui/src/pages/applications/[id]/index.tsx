      ...
      <Accordion heading={heading} initiallyOpen>
        <Flex>
          <ApplicationDatas>
            {section.ageGroup && (
              <ValueBox
                label={t("applicationSchedule:ageGroup")}
            ...
            <ValueBox
              label={t("applicationSchedule:groupSize")}
              value={formatNumber(section.numPersons, t("common:membersSuffix"))}
            />
            <ValueBox label={t("applicationSchedule:purpose")} value={section.purpose?.nameFi ?? undefined} />
            <ValueBox label={t("applicationSchedule:eventDuration")} value={duration} />
            <ValueBox label={t("applicationSchedule:eventsPerWeek")} value={`${section.appliedReservationsPerWeek}`} />
            <ValueBox label={t("applicationSchedule:dates")} value={dates} />
          </ApplicationDatas>
          <Flex $justifyContent="space-between" $direction="row" $alignItems="center">
            <H4 as="h3">{t("applicationSchedule:requestedReservationUnits")}</H4>
          ...
          <H4 as="h3">{t("applicationSchedule:requestedTimes")}</H4>
          <TimeSection>
