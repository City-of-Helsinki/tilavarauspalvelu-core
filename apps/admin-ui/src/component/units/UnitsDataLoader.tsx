...
import { filterEmptyArray, filterNonNullable, mapParamsToIntegers } from "common/src/helpers";
...
export function UnitsDataLoader({ isMyUnits }: Props): JSX.Element {
  ...
  const unitGroupFilter = filterEmptyArray(mapParamsToIntegers(searchParams.getAll("unitGroup"), 1));
