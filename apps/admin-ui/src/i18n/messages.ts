...
const translations: ITranslations = {
  ...
  RequestedReservation: {
    ...
    addressCountry: ["Maa"],
    addressForeign: ["Osoite ulkomailla"],
    addressAdditional: ["Lisätiedot"],
    ...
    reserveeAuthenticationStrong: ["Vahva"],
    reserveeShowContactInfo: ["Näytä yhteystiedot"],
    reserveeShowBirthDate: ["Näytä syntymäaika"],
    reserveeShowSSN: ["Näytä henkilötunnus"],
