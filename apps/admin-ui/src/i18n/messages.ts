...
const translations: ITranslations = {
  ...
  priceUnit: {
    PRICE_UNIT_FIXED: ["Per kerta"],
    PRICE_UNIT_PER_15_MINS: ["Per 15 min"],
    PRICE_UNIT_PER_30_MINS: ["Per 30 min"],
    PRICE_UNIT_PER_DAY: ["Per päivä"],
    PRICE_UNIT_PER_HALF_DAY: ["Per puoli päivää"],
    PRICE_UNIT_PER_HOUR: ["Per tunti"],
    PRICE_UNIT_PER_WEEK: ["Per viikko"],
  },
  orderStatus: {
    ALL: ["Maksuton"],
    PAID: ["Maksettu"],
