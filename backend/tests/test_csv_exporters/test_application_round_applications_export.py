...
def test_application_round_applications_export__multiple_applications(graphql):
    ...
    assert writes[3] == [
        *ApplicationExportRow(
            ...
            home_city_name=application_1.municipality,
    ...
    assert writes[4] == [
        *ApplicationExportRow(
            ...
            home_city_name=application_2.municipality,
...
def test_application_round_applications_export__missing_data(graphql, column_value_mapping, missing):
    ...
    data = {
        ...
        "application_sections__reservations_begin_date": application_round.reservation_period_begin_date,
        "application_sections__reservations_end_date": application_round.reservation_period_end_date,
        "application_sections__purpose__name": "free",
