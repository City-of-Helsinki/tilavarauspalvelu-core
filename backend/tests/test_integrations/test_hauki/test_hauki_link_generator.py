...
def test__hauki__link_generation__signature():
    link = generate_hauki_link(reservation_unit_uuid="123", user_email="foo@bar.com", organization_id=ORGANIZATION)
...
def test__hauki__link_generation__organization_none():
    link = generate_hauki_link(reservation_unit_uuid="123", user_email="foo@bar.com", organization_id=None)
