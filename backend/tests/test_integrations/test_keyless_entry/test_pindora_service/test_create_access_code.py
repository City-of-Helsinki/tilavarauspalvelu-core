...
def test_create_access_code__reservation():
    ...
    with patch_method(PindoraClient.request, return_value=ResponseMock(json_data=data)):
        response = PindoraService.create_access_code(obj=reservation, is_active=True)
...
def test_create_access_code__reservation__in_series():
    ...
    with patch_method(PindoraClient.request, return_value=ResponseMock(json_data=data)):
        response = PindoraService.create_access_code(obj=reservation_1, is_active=True)
...
def test_create_access_code__reservation__in_series__in_seasonal_booking():
...
def test_create_access_code__series():
    ...
    with patch_method(PindoraClient.request, return_value=ResponseMock(json_data=data)):
        response = PindoraService.create_access_code(obj=series, is_active=True)
...
def test_create_access_code__series__in_seasonal_booking():
    user = UserFactory.create()
    section = ApplicationSectionFactory.create(
        application__user=user,
    )
...
def test_create_access_code__seasonal_booking():
    user = UserFactory.create()
    section = ApplicationSectionFactory.create(
        application__user=user,
    )
    ...
    with patch_method(PindoraClient.request, return_value=ResponseMock(json_data=data)):
        response = PindoraService.create_access_code(obj=section, is_active=True)
