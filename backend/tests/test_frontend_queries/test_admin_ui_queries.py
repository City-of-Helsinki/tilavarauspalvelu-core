...
from .helpers import assert_no_undefined_args, get_admin_query_info
...
def test_frontend_queries__admin_ui__AllApplicationEvents(graphql):
    ...
    assert_no_undefined_args(factory_args, label="factory")
    ...
    assert_no_undefined_args(variables, label="variable")
...
def test_frontend_queries__admin_ui__ApplicationSectionAllocations(graphql):
    ...
    variables["applicationStatus"] = [obj.application.status.value]
    variables["reservationUnit"] = reservation_unit.pk
    variables["beginDate"] = application_round.application_period_begin.date().isoformat()
    variables["endDate"] = application_round.application_period_end.date().isoformat()
    assert_no_undefined_args(variables, label="variable")
...
def test_frontend_queries__admin_ui__HandlingData(graphql):
    ...
    assert_no_undefined_args(factory_args_1, label="factory")

    obj: Reservation = query_info_1.factory.create(**factory_args_1)

    factory_args_2 = query_info_2.factory_args
    assert_no_undefined_args(factory_args_2, label="factory")
...
def test_frontend_queries__admin_ui__Options(graphql):
    ...
    assert_no_undefined_args(factory_args_3, label="factory")
