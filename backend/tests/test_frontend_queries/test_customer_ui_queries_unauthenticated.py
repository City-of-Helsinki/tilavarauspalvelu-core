...
def test_frontend_queries__customer_ui__BlockingReservations__unauthenticated(graphql):
    customer_factories = get_customer_query_info()
...
def test_frontend_queries__customer_ui__ApplicationPagePreview__unauthenticated(graphql):
    customer_factories = get_customer_query_info()
