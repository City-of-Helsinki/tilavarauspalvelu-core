...
def get_factory_info_for_definition(operation: OperationDefinitionNode) -> list[QueryInfo]:
    ...
    for selection in operation.selection_set.selections:
        ...
        try:
            ...
            factory_args = get_factory_arguments(selection, model=factory._meta.model)
...
def get_factory_arguments(
    ...
    *,
    ...
    for selection in selection_node.selection_set.selections:
        factory_args = get_factory_arguments(selection, model=model, parent=field_name, root=root)
        factory_arguments |= factory_args
