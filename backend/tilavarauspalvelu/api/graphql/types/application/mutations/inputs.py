...
class ReservationUnitOptionInput(MutationType[ReservationUnitOption], kind="related"):
    pk = Input()
    preferred_order = Input()
    reservation_unit = Input()


class SuitableTimeRangeInput(MutationType[SuitableTimeRange], kind="related"):
    pk = Input()
    priority = Input()
...
class ApplicationSectionInput(MutationType[ApplicationSection], kind="related"):
    pk = Input()
    name = Input()
    num_persons = Input()
