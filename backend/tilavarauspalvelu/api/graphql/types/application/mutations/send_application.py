...
if TYPE_CHECKING:
    ...
    from tilavarauspalvelu.typing import ErrorList, GQLInfo
...
class ApplicationSendMutation(MutationType[Application], auto=False, kind="update"):
    pk = Input()
    ...
    @classmethod
    def __after__(cls, instance: Application, info: GQLInfo, previous_data: dict[str, Any]) -> None:
