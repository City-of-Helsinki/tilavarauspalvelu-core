...
from tilavarauspalvelu.models import AgeGroup, Purpose, Reservation, ReservationSeries, User
...
class ReservationSeriesReservationUpdateInput(MutationType[Reservation], kind="related"):
    ...
    # Relations
    purpose = Input(Purpose, required=False)
...
class ReservationSeriesUpdateMutation(MutationType[ReservationSeries]):
    ...
    reservation_details = Input(
        ReservationSeriesReservationUpdateInput,
    ...
    skip_reservations = Input(list[int], default_value=[])
