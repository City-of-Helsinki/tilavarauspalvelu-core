...
class ReservationSeriesRescheduleMutation(MutationType[ReservationSeries]):
    ...
    buffer_time_before = Input(datetime.timedelta, required=False)
    buffer_time_after = Input(datetime.timedelta, required=False)
    skip_dates = Input(list[datetime.date], default_value=[])
    ...
    def __mutate__(
        ...
        first_future_reservation = instance.reservations.future().order_by("begins_at").first()
        ...
        if begin_date != instance.begin_date and first_future_reservation.begins_at < now:
            msg = (
        ...
        buffer_time_before = input_data.pop("buffer_time_before", first_future_reservation.buffer_time_before)
        buffer_time_after = input_data.pop("buffer_time_after", first_future_reservation.buffer_time_after)
