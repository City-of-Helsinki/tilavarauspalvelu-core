...
__all__ = [
    "ReservationSeriesPermission",
]


class ReservationSeriesPermission(BasePermission):
    @classmethod
    def has_permission(cls, user: AnyUser) -> bool:
        return user.is_authenticated

    @classmethod
    def has_node_permission(cls, instance: ReservationSeries, user: AnyUser, filters: GraphQLFilterInfo) -> bool:
    ...
    @classmethod
    def has_update_permission(cls, instance: ReservationSeries, user: AnyUser, input_data: dict[str, Any]) -> bool:
    ...
    def _get_reservation_unit(cls, input_data: dict[str, Any]) -> ReservationUnit:
        ...
        if pk is None:
            msg = "Reservation Unit is required for creating a Reservation Series."
