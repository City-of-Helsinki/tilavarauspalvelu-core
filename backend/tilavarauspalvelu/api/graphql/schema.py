...
class Query(RootType):
    ...
    @order.resolve
    def resolve_order(self, info: GQLInfo[User], *, order_uuid: str) -> PaymentOrder:
    ...
    def resolve_affecting_reservations(
        ...
        *,
        ...
        queryset = (
            ...
            .filter(
                begins_at__gte=local_start_of_day(begin_date),
                ends_at__lte=local_end_of_day(end_date),
            )
        )
