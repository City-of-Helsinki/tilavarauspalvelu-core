...
class ReservationUnitFirstReservableTimeHelper:
    ...
    def get_access_type_for_date(
        ...
        # Loop through the access types in REVERSE order to find the access type active at the first reservable time
        access_types: list[ReservationUnitAccessType] = sorted(
