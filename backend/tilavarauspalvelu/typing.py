...
class ReservationApproveData(TypedDict):
    ...
    handling_details: NotRequired[str]
...
class ReservationUnitData(TypedDict, total=False):
    ...
    cancellation_rule: int | None
    metadata_set: int | None
    cancellation_terms: int | None
    service_specific_terms: int | None
    pricing_terms: int | None
