...
class TaxPercentage(models.Model):
    ...
    objects: ClassVar[TaxPercentageManager] = LazyModelManager()
    actions: TaxPercentageActions = LazyModelAttribute()
    validators: TaxPercentageValidator = LazyModelAttribute()
