...
class ReservationCancelReason(models.Model):
    ...
    objects: ClassVar[ReservationCancelReasonManager] = LazyModelManager()
    actions: ReservationCancelReasonActions = LazyModelAttribute()
    validators: ReservationCancelReasonValidator = LazyModelAttribute()
