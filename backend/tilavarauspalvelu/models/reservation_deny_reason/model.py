...
class ReservationDenyReason(models.Model):
    ...
    objects: ClassVar[ReservationDenyReasonManager] = LazyModelManager()
    actions: ReservationDenyReasonActions = LazyModelAttribute()
    validators: ReservationDenyReasonValidator = LazyModelAttribute()
