...
class PaymentOrder(models.Model):
    ...
    objects: ClassVar[PaymentOrderManager] = LazyModelManager()
    actions: PaymentOrderActions = LazyModelAttribute()
    validators: PaymentOrderValidator = LazyModelAttribute()
