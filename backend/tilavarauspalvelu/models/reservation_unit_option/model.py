...
class ReservationUnitOption(models.Model):
    ...
    objects: ClassVar[ReservationUnitOptionManager] = LazyModelManager()
    actions: ReservationUnitOptionActions = LazyModelAttribute()
    validators: ReservationUnitOptionValidator = LazyModelAttribute()
