...
class ReservableTimeSpan(models.Model):
    ...
    objects: ClassVar[ReservableTimeSpanManager] = LazyModelManager()
    actions: ReservableTimeSpanActions = LazyModelAttribute()
    validators: ReservableTimeSpanValidator = LazyModelAttribute()
