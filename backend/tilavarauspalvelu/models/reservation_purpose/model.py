...
class ReservationPurpose(models.Model):
    ...
    objects: ClassVar[ReservationPurposeManager] = LazyModelManager()
    actions: ReservationPurposeActions = LazyModelAttribute()
    validators: ReservationPurposeValidator = LazyModelAttribute()
