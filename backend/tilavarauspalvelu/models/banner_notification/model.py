...
class BannerNotification(models.Model):
    ...
    objects: ClassVar[BannerNotificationManager] = LazyModelManager()
    actions: BannerNotificationActions = LazyModelAttribute()
    validators: BannerNotificationValidator = LazyModelAttribute()
