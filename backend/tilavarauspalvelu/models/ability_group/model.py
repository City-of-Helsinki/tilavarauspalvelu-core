...
class AbilityGroup(models.Model):
    ...
    objects: ClassVar[AbilityGroupManager] = LazyModelManager()
    actions: AbilityGroupActions = LazyModelAttribute()
    validators: AbilityGroupValidator = LazyModelAttribute()
