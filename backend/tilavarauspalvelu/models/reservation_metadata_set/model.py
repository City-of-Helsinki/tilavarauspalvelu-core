...
class ReservationMetadataSet(models.Model):
    ...
    objects: ClassVar[ReservationMetadataSetManager] = LazyModelManager()
    actions: ReservationMetadataSetActions = LazyModelAttribute()
    validators: ReservationMetadataSetValidator = LazyModelAttribute()
