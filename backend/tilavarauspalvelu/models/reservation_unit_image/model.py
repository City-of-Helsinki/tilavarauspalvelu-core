...
class ReservationUnitImage(models.Model):
    ...
    objects: ClassVar[ReservationUnitImageManager] = LazyModelManager()
    actions: ReservationUnitImageActions = LazyModelAttribute()
    validators: ReservationUnitImageValidator = LazyModelAttribute()
