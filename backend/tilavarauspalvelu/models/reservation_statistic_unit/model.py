...
class ReservationStatisticsReservationUnit(models.Model):
    ...
    objects: ClassVar[ReservationStatisticsReservationUnitManager] = LazyModelManager()
    actions: ReservationStatisticsReservationUnitActions = LazyModelAttribute()
    validators: ReservationStatisticsReservationUnitValidator = LazyModelAttribute()
