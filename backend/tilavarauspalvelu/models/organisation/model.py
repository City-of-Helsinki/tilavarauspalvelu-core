...
class Organisation(SerializableMixin, models.Model):
    ...
    objects: ClassVar[OrganisationManager] = LazyModelManager()
    actions: OrganisationActions = LazyModelAttribute()
    validators: OrganisationValidator = LazyModelAttribute()
