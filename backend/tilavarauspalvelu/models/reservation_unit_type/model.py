...
class ReservationUnitType(models.Model):
    ...
    objects: ClassVar[ReservationUnitTypeManager] = LazyModelManager()
    actions: ReservationUnitTypeActions = LazyModelAttribute()
    validators: ReservationUnitTypeValidator = LazyModelAttribute()
