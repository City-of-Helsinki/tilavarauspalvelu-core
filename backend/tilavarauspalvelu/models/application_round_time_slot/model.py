...
class ApplicationRoundTimeSlot(models.Model):
    ...
    objects: ClassVar[ApplicationRoundTimeSlotManager] = LazyModelManager()
    actions: ApplicationRoundTimeSlotActions = LazyModelAttribute()
    validators: ApplicationRoundTimeSlotValidator = LazyModelAttribute()
