...
class PersonalInfoViewLog(models.Model):
    ...
    objects: ClassVar[PersonalInfoViewLogManager] = LazyModelManager()
    actions: PersonalInfoViewLogActions = LazyModelAttribute()
    validators: PersonalInfoViewLogValidator = LazyModelAttribute()
