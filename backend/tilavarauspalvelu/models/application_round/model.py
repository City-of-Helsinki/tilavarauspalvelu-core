...
class ApplicationRound(models.Model):
    ...
    objects: ClassVar[ApplicationRoundManager] = LazyModelManager()
    actions: ApplicationRoundActions = LazyModelAttribute()
    validators: ApplicationRoundValidator = LazyModelAttribute()
