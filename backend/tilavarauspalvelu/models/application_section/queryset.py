...
_BaseManager: type[models.Manager] = SerializableMixin.SerializableManager.from_queryset(ApplicationSectionQuerySet)  # type: ignore[assignment]


class ApplicationSectionManager(_BaseManager):
    # Define to get type hints for queryset methods.
    def all(self) -> ApplicationSectionQuerySet:
