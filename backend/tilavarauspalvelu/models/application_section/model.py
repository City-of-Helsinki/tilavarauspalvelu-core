...
class ApplicationSection(SerializableMixin, models.Model):
    ...
    objects: ClassVar[ApplicationSectionManager] = LazyModelManager()
    actions: ApplicationSectionActions = LazyModelAttribute()
    validators: ApplicationSectionValidator = LazyModelAttribute()
