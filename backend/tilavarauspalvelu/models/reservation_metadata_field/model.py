...
class ReservationMetadataField(models.Model):
    ...
    objects: ClassVar[ReservationMetadataFieldManager] = LazyModelManager()
    actions: ReservationMetadataFieldActions = LazyModelAttribute()
    validators: ReservationMetadataFieldValidator = LazyModelAttribute()
