...
class ReservationUnitPaymentType(models.Model):
    ...
    objects: ClassVar[ReservationUnitPaymentTypeManager] = LazyModelManager()
    actions: ReservationUnitPaymentTypeActions = LazyModelAttribute()
    validators: ReservationUnitPaymentTypeValidator = LazyModelAttribute()
