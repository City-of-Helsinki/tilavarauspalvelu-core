...
class User(AbstractUser):
    ...
    objects: ClassVar[UserManager] = LazyModelManager()
    actions: UserActions = LazyModelAttribute()
    validators: UserValidator = LazyModelAttribute()
...
class ProfileUser(SerializableMixin, User):
    ...
    objects: ClassVar[ProfileUserManager] = LazyModelManager()
