...
class ReservationUnitHierarchy(models.Model):
    ...
    objects: ClassVar[ReservationUnitHierarchyManager] = LazyModelManager()
    actions: ReservationUnitHierarchyActions = LazyModelAttribute()
    validators: ReservationUnitHierarchyValidator = LazyModelAttribute()
