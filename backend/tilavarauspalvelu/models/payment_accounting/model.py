...
class PaymentAccounting(models.Model):
    ...
    objects: ClassVar[PaymentAccountingManager] = LazyModelManager()
    actions: PaymentAccountingActions = LazyModelAttribute()
    validators: PaymentAccountingValidator = LazyModelAttribute()
