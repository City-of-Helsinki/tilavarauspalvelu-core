...
class OriginHaukiResource(models.Model):
    ...
    objects: ClassVar[OriginHaukiResourceManager] = LazyModelManager()
    actions: OriginHaukiResourceActions = LazyModelAttribute()
    validators: OriginHaukiResourceValidator = LazyModelAttribute()
