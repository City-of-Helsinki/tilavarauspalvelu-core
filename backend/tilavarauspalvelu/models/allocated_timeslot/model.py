...
class AllocatedTimeSlot(models.Model):
    ...
    objects: ClassVar[AllocatedTimeSlotManager] = LazyModelManager()
    actions: AllocatedTimeSlotActions = LazyModelAttribute()
    validators: AllocatedTimeSlotValidator = LazyModelAttribute()
