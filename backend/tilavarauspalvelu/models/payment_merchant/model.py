...
class PaymentMerchant(models.Model):
    ...
    objects: ClassVar[PaymentMerchantManager] = LazyModelManager()
    actions: PaymentMerchantActions = LazyModelAttribute()
    validators: PaymentMerchantValidator = LazyModelAttribute()
