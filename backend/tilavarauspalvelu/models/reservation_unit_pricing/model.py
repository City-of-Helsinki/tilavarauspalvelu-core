...
class ReservationUnitPricing(models.Model):
    ...
    objects: ClassVar[ReservationUnitPricingManager] = LazyModelManager()
    actions: ReservationUnitPricingActions = LazyModelAttribute()
    validators: ReservationUnitPricingValidator = LazyModelAttribute()
