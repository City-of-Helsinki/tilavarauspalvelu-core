...
class EquipmentCategory(models.Model):
    ...
    objects: ClassVar[EquipmentCategoryManager] = LazyModelManager()
    actions: EquipmentCategoryActions = LazyModelAttribute()
    validators: EquipmentCategoryValidator = LazyModelAttribute()
