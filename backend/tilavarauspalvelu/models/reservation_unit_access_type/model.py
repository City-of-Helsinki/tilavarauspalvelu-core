...
class ReservationUnitAccessType(models.Model):
    ...
    @cached_property
    def validator(self) -> ReservationUnitAccessTypeValidator:
        """
        Validation logic that requires access to a ReservationUnitAccessType,
        ...
        return ReservationUnitAccessTypeValidator(self)
