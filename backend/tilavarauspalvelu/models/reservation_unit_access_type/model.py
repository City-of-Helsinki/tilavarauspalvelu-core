...
class ReservationUnitAccessType(models.Model):
    ...
    objects: ClassVar[ReservationUnitAccessTypeManager] = LazyModelManager()
    actions: ReservationUnitAccessTypeActions = LazyModelAttribute()
    validators: ReservationUnitAccessTypeValidator = LazyModelAttribute()
