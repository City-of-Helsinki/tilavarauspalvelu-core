...
class PaymentProduct(models.Model):
    ...
    objects: ClassVar[PaymentProductManager] = LazyModelManager()
    actions: PaymentProductActions = LazyModelAttribute()
    validators: PaymentProductValidator = LazyModelAttribute()
