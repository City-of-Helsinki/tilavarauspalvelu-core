...
class ReservationUnit(models.Model):
    ...
    objects: ClassVar[ReservationUnitManager] = LazyModelManager()
    actions: ReservationUnitActions = LazyModelAttribute()
    validators: ReservationUnitValidator = LazyModelAttribute()
