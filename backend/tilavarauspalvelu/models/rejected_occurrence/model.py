...
class RejectedOccurrence(models.Model):
    ...
    objects: ClassVar[RejectedOccurrenceManager] = LazyModelManager()
    actions: RejectedOccurrenceActions = LazyModelAttribute()
    validators: RejectedOccurrenceValidator = LazyModelAttribute()
