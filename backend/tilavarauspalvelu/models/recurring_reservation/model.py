...
class RecurringReservation(models.Model):
    ...
    objects: ClassVar[RecurringReservationManager] = LazyModelManager()
    actions: RecurringReservationActions = LazyModelAttribute()
    validators: ReservationSeriesValidator = LazyModelAttribute()
