...
class AffectingTimeSpan(models.Model):
    ...
    objects: ClassVar[AffectingTimeSpanManager] = LazyModelManager()
    actions: AffectingTimeSpanActions = LazyModelAttribute()
    validators: AffectingTimeSpanValidator = LazyModelAttribute()
