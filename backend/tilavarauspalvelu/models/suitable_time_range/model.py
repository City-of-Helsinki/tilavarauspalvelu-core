...
class SuitableTimeRange(models.Model):
    ...
    objects: ClassVar[SuitableTimeRangeManager] = LazyModelManager()
    actions: SuitableTimeRangeActions = LazyModelAttribute()
    validators: SuitableTimeRangeValidator = LazyModelAttribute()
