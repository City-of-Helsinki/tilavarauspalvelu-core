...
class ReservationUnitCancellationRule(models.Model):
    ...
    objects: ClassVar[ReservationUnitCancellationRuleManager] = LazyModelManager()
    actions: ReservationUnitCancellationRuleActions = LazyModelAttribute()
    validators: ReservationUnitCancellationRuleValidator = LazyModelAttribute()
