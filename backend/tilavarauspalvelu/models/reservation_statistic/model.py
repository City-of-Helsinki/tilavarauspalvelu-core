...
class ReservationStatistic(models.Model):
    ...
    objects: ClassVar[ReservationStatisticManager] = LazyModelManager()
    actions: ReservationStatisticActions = LazyModelAttribute()
    validators: ReservationStatisticValidator = LazyModelAttribute()
