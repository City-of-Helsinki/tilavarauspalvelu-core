...
import { ReserveeType, ReservationFormType } from "../../gql/gql-types";
...
function getFormFields(type: ReservationFormType): FormFieldArray {
  const schema = getReservationSchemaBase(type)({ minPersons: 1, maxPersons: Infinity, numPersonsRequired: false });
