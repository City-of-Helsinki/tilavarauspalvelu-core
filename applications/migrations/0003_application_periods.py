    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('purposes', models.ManyToManyField(blank=True, related_name='application_periods', to='reservation_units.Purpose', verbose_name='Purposes')),
                ('reservation_units', models.ManyToManyField(related_name='application_periods', to='reservation_units.ReservationUnit', verbose_name='Reservation units')),
            ],
        ),
        migrations.AddField(
            model_name='application',
            name='application_period',
            field=models.ForeignKey(default=0, on_delete=django.db.models.deletion.PROTECT, to='applications.ApplicationPeriod', verbose_name='Applicantion period'),
