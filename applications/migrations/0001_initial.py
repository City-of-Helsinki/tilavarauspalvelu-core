    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='applications.Address')),
            ],
        ),
        migrations.CreateModel(
            name='Application',
            fields=[
                ...
                ('contact_person', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='applications.Person', verbose_name='Contact person')),
                ('organisation', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='applications.Organisation', verbose_name='Organisation')),
                ('reservation_purpose', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='reservations.ReservationPurpose', verbose_name='Purpose')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name='Applicant')),
            ],
        ),
    ]
