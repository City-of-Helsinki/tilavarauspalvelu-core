...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('reservations', '0076_reservationstatistic_reservee_address_zip_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='paymentaccounting',
            name='project',
            field=models.CharField(blank=True, default='', max_length=16, validators=[merchants.validators.validate_accounting_project, merchants.validators.is_numeric]),
        ),
        migrations.AlterField(
            model_name='paymentaccounting',
            name='vat_code',
        ...
        migrations.AlterField(
            model_name='paymentorder',
            name='payment_type',
            field=models.CharField(choices=[('ON_SITE', 'On site'), ('ONLINE', 'Online'), ('INVOICE', 'Invoice')], max_length=128),
        ),
        migrations.AlterField(
            model_name='paymentorder',
            name='price_net',
        ...
        migrations.AlterField(
            model_name='paymentorder',
            name='reservation',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='payment_order', to='reservations.reservation'),
        ),
        migrations.AlterField(
            model_name='paymentorder',
        ...
        migrations.AlterField(
            model_name='paymentorder',
            name='status',
            field=models.CharField(choices=[('DRAFT', 'Draft'), ('EXPIRED', 'Expired'), ('CANCELLED', 'Cancelled'), ('PAID', 'Paid'), ('PAID_MANUALLY', 'Paid manually'), ('REFUNDED', 'Refunded')], db_index=True, max_length=128),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='paymentproduct',
            name='merchant',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='products', to='merchants.paymentmerchant'),
        ),
    ]
