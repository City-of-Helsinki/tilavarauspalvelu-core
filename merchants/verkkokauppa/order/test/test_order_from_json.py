...
class OrderFromJsonTestCase(TestCase):
    ...
    def test_order_from_json():
        ...
        assert_that(order.order_id).is_equal_to(uuid.UUID("b6b6b6b6-b6b6-b6b6-b6b6-b6b6b6b6b6b6"))
        ...
        assert_that(order.items[0].order_item_id).is_equal_to(uuid.UUID("b6b6b6b6-b6b6-b6b6-b6b6-b6b6b6b6b6b6"))
        assert_that(order.items[0].order_id).is_equal_to(uuid.UUID("b6b6b6b6-b6b6-b6b6-b6b6-b6b6b6b6b6b6"))
        assert_that(order.items[0].product_id).is_equal_to(uuid.UUID("b6b6b6b6-b6b6-b6b6-b6b6-b6b6b6b6b6b6"))
        ...
        assert_that(order.items[0].meta[0].order_item_meta_id).is_equal_to(
            uuid.UUID("b6b6b6b6-b6b6-b6b6-b6b6-b6b6b6b6b6b6"),
        )
