...
const translations: ITranslations = {
  ...
  ReservationUnitEditor: {
    ...
    cancellationTermsLabel: ["Peruutusehdot"],
    cancellationTermsPlaceholder: ["Valitse"],
    cancellationTermsHelperText: ["Valitse lorem ipsum tästä"],
    serviceSpecificTermsLabel: ["Palvelukohtaiset täydentävät ehdot"],
    ...
    publishingSettings: ["Julkaisemisen asetukset"],
    publishBegins: ["Näytä alkaen"],
    publishEnds: ["Piilota tällöin"],
    scheduledReservation: ["Ajastettu varaaminen"],
  ...
  SingleApplication: {
    ...
    ApproveDialog: {
      title: ["Hyväksy anomus"],
      accept: ["Hyväksy anomus"],
      errorSaving: ["Hyväksyminen ei onnistunut."],
      approved: ["Anomus hyväksytty."],
