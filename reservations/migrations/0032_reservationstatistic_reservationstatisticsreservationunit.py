        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(default=django.utils.timezone.now, null=True, verbose_name="Created at"),
                ),
                (
                    "reservation_handled_at",
                    models.DateTimeField(
                        blank=True, help_text="When this reservation was handled.", null=True, verbose_name="Handled at"
                    ),
                ),
                ...
                (
                    "reservee_language",
                    models.CharField(
                        blank=True, default="", max_length=255, verbose_name="Preferred language of reservee"
                    ),
                ),
                ...
                (
                    "is_applied",
                    models.BooleanField(
                        blank=True, default=False, verbose_name="Is the reservation done through application process."
                    ),
                ),
                ...
                (
                    ...
                    models.BooleanField(
                        ...
                        null=True,
                        verbose_name="Reservation is internal",
                    ),
                ),
                ...
                (
                    "cancel_reason_text",
                    models.CharField(max_length=255, verbose_name="The reason text of the cancel reason"),
                ),
                (
                    "deny_reason_text",
                    models.CharField(max_length=255, verbose_name="The reason text of the deny reason"),
                ),
                (
                    "price",
                    models.DecimalField(
                ...
                (
                    ...
                    models.DecimalField(
                        ...
                        max_digits=5,
                        verbose_name="Tax percentage value",
                    ),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        null=True, on_delete=django.db.models.deletion.SET_NULL, to="reservation_units.ReservationUnit"
                    ),
                ),
                (
                    "purpose",
                ...
                (
                    ...
                    models.OneToOneField(
                        null=True, on_delete=django.db.models.deletion.SET_NULL, to="reservations.Reservation"
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="reservations.ReservationStatistic",
                    ),
                ),
                (
                    "reservation_unit",
