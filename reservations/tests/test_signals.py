...
class ReservationSignalTestCase(TestCase):
    ...
    def setUpTestData(cls) -> None:
        ...
        cls.reservation_unit = ReservationUnitFactory(
            name="Test reservation unit", unit=cls.unit
        )
    ...
    def test_creating_reservation_creates_statistics(self):
        ...
        assert_that(statistics.primary_reservation_unit).is_equal_to(
            self.reservation_unit
        )
        assert_that(statistics.primary_reservation_unit_name).is_equal_to(
    ...
    def test_updating_reservation_updates_statistics(self):
        ...
        new_reservation_unit = ReservationUnitFactory(
            name="Another reservation unit", unit=new_unit
        )
        ...
        assert_that(statistics.reservation).is_equal_to(reservation)
        assert_that(statistics.primary_reservation_unit).is_equal_to(
            new_reservation_unit
        )
        assert_that(statistics.primary_reservation_unit_name).is_equal_to(
            new_reservation_unit.name
        )
