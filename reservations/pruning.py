...
def prune_inactive_reservations() -> None:
    ...
    """
    older_than_minutes = settings.PRUNE_OLDER_THAN_MINUTES
...
def prune_reservation_statistics() -> None:
    ...
    older_than_years = settings.REMOVE_STATS_OLDER_THAN_YEARS
...
def prune_recurring_reservations() -> None:
    ...
    older_than_days = settings.REMOVE_RECURRINGS_OLDER_THAN_DAYS
