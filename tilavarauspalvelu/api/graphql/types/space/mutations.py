...
from tilavarauspalvelu.api.graphql.types.space.permissions import SpacePermission
from tilavarauspalvelu.api.graphql.types.space.serializers import SpaceSerializer
