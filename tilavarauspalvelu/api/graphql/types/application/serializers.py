...
from tilavarauspalvelu.enums import ApplicantTypeChoice, ApplicationStatusChoice, OrganizationTypeChoice, Weekday
...
class ApplicationSendSerializer(NestingModelSerializer):
    ...
    def validate_community_applicant(self, errors: defaultdict[str, list[str]]) -> None:
        self.validate_contact_person(errors)
        org_types = [
            OrganizationTypeChoice.RELIGIOUS_COMMUNITY,
        ]
        self.validate_organisation(errors, allowed_organisation_types=org_types, require_home_city=True)
    ...
    def validate_company_applicant(self, errors: defaultdict[str, list[str]]) -> None:
        self.validate_contact_person(errors)
        org_types = [
            OrganizationTypeChoice.COMPANY,
        ]
        self.validate_organisation(errors, allowed_organisation_types=org_types, require_identifier=True)
    ...
    def validate_organisation(
        ...
        *,
        allowed_organisation_types: Collection[OrganizationTypeChoice],
        ...
        if organisation is None:
            ...
            if OrganizationTypeChoice(organisation.organisation_type) not in allowed_organisation_types:
                msg = "Application organisation type is incorrect for the given applicant type."
                errors[api_settings.NON_FIELD_ERRORS_KEY].append(msg)
