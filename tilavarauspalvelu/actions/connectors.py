...
class ApplicationActionsConnector:
    def __get__(self, instance, _):
        ...
        from tilavarauspalvelu.actions.application import ApplicationActions
...
class ApplicationSectionActionsConnector:
    def __get__(self, instance, _):
        _raise_if_accessed_on_class(instance)
        from tilavarauspalvelu.actions.application_section import ApplicationSectionActions
...
class SuitableTimeRangeActionsConnector:
    def __get__(self, instance, _):
        _raise_if_accessed_on_class(instance)
        from tilavarauspalvelu.actions.suitable_time_range import SuitableTimeRangeActions
...
class AllocatedTimeSlotActionsConnector:
    def __get__(self, instance, _):
        _raise_if_accessed_on_class(instance)
        from tilavarauspalvelu.actions.allocated_time_slot import AllocatedTimeSlotActions
...
class ApplicationRoundActionsConnector:
    def __get__(self, instance, _):
        _raise_if_accessed_on_class(instance)
        from tilavarauspalvelu.actions.application_round import ApplicationRoundActions
...
class ReservationUnitOptionActionsConnector:
    def __get__(self, instance, _):
        _raise_if_accessed_on_class(instance)
        from tilavarauspalvelu.actions.reservation_unit_option import ReservationUnitOptionActions
...
class ReservationUnitActionsConnector:
    def __get__(self, instance, _):
        _raise_if_accessed_on_class(instance)
        from tilavarauspalvelu.actions.reservation_unit import ReservationUnitActions
...
class ReservationActionsConnector:
    def __get__(self, instance, _):
        _raise_if_accessed_on_class(instance)
        from tilavarauspalvelu.actions.reservation import ReservationActions
...
class RecurringReservationActionsConnector:
    def __get__(self, instance, _):
        _raise_if_accessed_on_class(instance)
        from tilavarauspalvelu.actions.recurring_reservation import RecurringReservationActions
...
class RejectedOccurrenceActionsConnector:
    def __get__(self, instance, _):
        _raise_if_accessed_on_class(instance)
        from tilavarauspalvelu.actions.rejected_occurrence import RejectedOccurrenceActions
