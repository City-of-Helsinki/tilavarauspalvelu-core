            ...
            state_operations=[
                migrations.CreateModel(
                    ...
                    fields=[
                        ...
                        (
                            "authentication",
                            models.CharField(
                                choices=[("weak", "Weak"), ("strong", "Strong")], default="weak", max_length=20
                            ),
                        ),
                        (
                        ...
                        (
                            "spaces",
                            models.ManyToManyField(
                                blank=True, related_name="reservation_units", to="tilavarauspalvelu.space"
                            ),
                        ),
                        (
                            "unit",
                ...
                migrations.AlterField(
                    ...
                    field=models.CharField(
                        choices=[("ONLINE", "Online"), ("ON_SITE", "On site"), ("INVOICE", "Invoice")], max_length=128
                    ),
                ),
                migrations.CreateModel(
                ...
                migrations.AddField(
                    ...
                    name="purposes",
                    field=models.ManyToManyField(
                        blank=True, related_name="reservation_units", to="tilavarauspalvelu.purpose"
                    ),
                ),
                migrations.AddField(
                    model_name="reservationunit",
                ...
                migrations.CreateModel(
                    ...
                    fields=[
                        ...
                        (
                            "image",
                            easy_thumbnails.fields.ThumbnailerImageField(
                                null=True, upload_to="reservation_unit_images"
                            ),
                        ),
                        (
                            "image_type",
