...
class Migration(migrations.Migration):
    dependencies = [
        ...
        ("opening_hours", "0005_remove_reservabletimespan_resource_and_more"),
        ("permissions", "0035_remove_unitrole_assigner_remove_unitrole_unit_groups_and_more"),
        ("reservation_units", "0112_remove_equipment_category_and_more"),
        ("reservations", "0084_delete_agegroup_delete_rejectedoccurrence_and_more"),
            ...
            state_operations=[
                ...
                migrations.AddConstraint(
                    ...
                    constraint=models.CheckConstraint(
                        ...
                        violation_error_message=(
                            "Reservation min and max durations must be multiples of 30 minutes, "
