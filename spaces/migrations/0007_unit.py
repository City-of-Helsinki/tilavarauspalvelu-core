    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "service_map_id",
                    models.CharField(blank=True, max_length=255, null=True, unique=True, verbose_name="Service map id"),
                ),
                ("name", models.CharField(max_length=255, verbose_name="Name")),
                ("description", models.TextField(blank=True, default="", max_length=255, verbose_name="Description")),
                (
                    "short_description",
                    models.CharField(blank=True, default="", max_length=255, verbose_name="Short description"),
                ),
                (
                    "web_page",
                    models.URLField(blank=True, default="", max_length=255, verbose_name="Homepage for the unit"),
                ),
