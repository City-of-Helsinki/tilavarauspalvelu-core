...
class ReservationUnitStateHelperTestCase(TestCase):
    ...
    def test_get_state_with_archived(self):
        ...
        assert ReservationUnitStateHelper.get_state(self.reservation_unit) == ReservationUnitState.ARCHIVED
    ...
    def test_get_state_with_draft(self):
        ...
        self.reservation_unit.is_draft = True
        assert ReservationUnitStateHelper.get_state(self.reservation_unit) == ReservationUnitState.DRAFT
    ...
    def test_get_state_with_scheduled_publishing_and_publish_begins(self):
        ...
        assert ReservationUnitStateHelper.get_state(self.reservation_unit) == ReservationUnitState.SCHEDULED_PUBLISHING
    ...
    def test_get_state_with_published(self):
        self.reservation_unit.is_archived = False
        self.reservation_unit.is_draft = False
        assert ReservationUnitStateHelper.get_state(self.reservation_unit) == ReservationUnitState.PUBLISHED
    ...
    def test_get_state_with_hidden(self):
        ...
        assert ReservationUnitStateHelper.get_state(self.reservation_unit) == ReservationUnitState.HIDDEN
    ...
    def test_get_state_with_scheduled_hiding(self):
        ...
        self.reservation_unit.publish_ends = self.now + datetime.timedelta(hours=1)
        assert ReservationUnitStateHelper.get_state(self.reservation_unit) == ReservationUnitState.SCHEDULED_HIDING
    ...
    def test_get_state_with_scheduled_period(self):
        ...
        assert ReservationUnitStateHelper.get_state(self.reservation_unit) == ReservationUnitState.SCHEDULED_PERIOD
