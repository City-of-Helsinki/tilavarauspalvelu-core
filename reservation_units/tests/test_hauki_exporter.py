...
class HaukiExporterTestCase(TestCase):
    ...
    def test_get_parent_id_return_none_when_parent_not_in_hauki_and_request_errors(self, hauki_mock):
    ...
    def test_get_hauki_resource_object_from_reservation_unit_raises_when_parent_id_is_none(self, hauki_mock):
    ...
    def test_send_reservation_unit_to_hauki_update_existing_resource(self, send_mock, hauki_mock):
