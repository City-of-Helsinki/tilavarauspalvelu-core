...
class ReservationUnitDataExporterTestCase(TestCase):
    ...
    def test_basic_case(self):
        ...
        expected_line = [
            ...
            self.reservation_unit.price_unit,
            self.reservation_unit.lowest_price,
            self.reservation_unit.highest_price,
            self.reservation_unit.tax_percentage,
            ...
            ", ".join(
                self.reservation_unit.reservation_purposes.all().values_list(
                    "name_fi", flat=True
                )
            ),
