                ...
                for reservation_unit in reservation_units:
                    reservations_writer.writerow(
                        [
                            ...
                            reservation_unit.price_unit,
                            reservation_unit.lowest_price,
                            reservation_unit.highest_price,
                            reservation_unit.tax_percentage,
                            ...
                            reservation_unit.pricing_type,
                            reservation_unit.payment_type,
                            ...
                            ", ".join(
                                reservation_unit.reservation_purposes.all().values_list(
                                    "name_fi", flat=True
                                )
                            ),
