                ...
                for reservation_unit in reservation_units:
                    ...
                    reservations_writer.writerow(
                        [
                            ...
                            getattr(reservation_unit.service_specific_terms, "name", ""),
                            ...
                            getattr(pricing, "price_unit", ""),
                            getattr(pricing, "lowest_price", ""),
                            getattr(pricing, "highest_price", ""),
                            getattr(pricing, "tax_percentage", ""),
                            (
