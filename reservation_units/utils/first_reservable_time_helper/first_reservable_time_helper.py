...
class FirstReservableTimeHelper:
    ...
    def calculate_all_first_reservable_times(self) -> None:
        ...
        # starting from where the pagination args tell us, and continue until we have gathered enough results to
        # fill the page size.
        qs = self.optimized_reservation_unit_queryset

        # TODO: Setup job to refresh hierarchy in platta envs!
        # TODO: Have some cached value here that when expired refreshes the materialized view?
